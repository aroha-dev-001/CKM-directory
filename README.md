...
| `bean-to-cup.html` | Baba Budan then the cup — sequential coffee story (00–14), companion sage theme, one still per beat |
...
- **Bean to Cup** (`bean-to-cup.html`) is the companion coffee story in sage cream: fifteen sequential beats (Baba Budan 00–08, then shade-to-davara 09–14), one still per beat, with a filmstrip of the whole walk. No Kyoto hall. Not a shop. The homepage **Bean to cup** band opens this page.
