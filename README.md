...
- `places.html` opens with a React Bits **DriftWall** (vanilla port): destination stills drift in columns. Click a tile to pause the wall and flip it for a two-to-three-line note.
