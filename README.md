...
- Coffee origin scene index uses a React Bits **Stack** (ported to vanilla JS + GSAP): eight companion illustrations, click or drag to send a card back, autoplay with pause on hover.
