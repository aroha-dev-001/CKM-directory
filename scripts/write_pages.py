...
<html lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="style.css?v=sage38" />
    <link rel="stylesheet" href="threeui.css?v=sylva1" />
  ...
  <body data-page="{page}">
    ...
    <script src="sections.js?v=sage48"></script>
    ...
    <script src="sylva-hero.js?v=sylva4"></script>
