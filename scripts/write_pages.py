...
<html lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="style.css?v=sage16" />
    <link rel="stylesheet" href="carousel.css?v=sage6" />
    <link rel="stylesheet" href="drift-wall.css?v=sage5" />
  </head>
  <body data-page="{page}">
    ...
    <script src="drift-wall.js?v=sage5"></script>
    <script src="app.js?v=sage16"></script>
  </body>
</html>
"""
