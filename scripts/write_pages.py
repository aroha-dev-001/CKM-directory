...
<html lang="en">
  ...
  <body data-page="{page}">
    ...
    <script src="data.js?v=sage2"></script>
    <script src="sections.js?v=sage2"></script>
    <script src="map.js?v=sage2"></script>
    <script src="accordion-gallery.js?v=sage2"></script>
    <script src="app.js?v=sage2"></script>
  </body>
</html>
"""
