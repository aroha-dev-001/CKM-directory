...
<html lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="style.css?v=sage9" />
    <link rel="stylesheet" href="carousel.css?v=sage5" />
    <link rel="stylesheet" href="circular-gallery.css?v=sage9" />
  </head>
  <body data-page="{page}">
    ...
    <script src="data.js?v=sage9"></script>
    <script src="sections.js?v=sage9"></script>
    <script src="map.js?v=sage5"></script>
    <script src="carousel.js?v=sage5"></script>
    <script src="app.js?v=sage9"></script>
  </body>
</html>
"""
