...
<html lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="style.css?v=sage8" />
    <link rel="stylesheet" href="carousel.css?v=sage5" />
    <link rel="stylesheet" href="origin-slider.css?v=sage8" />
  </head>
  <body data-page="{page}">
    ...
    <script src="data.js?v=sage7"></script>
    <script src="sections.js?v=sage8"></script>
    <script src="map.js?v=sage5"></script>
    <script src="carousel.js?v=sage5"></script>
    <script src="origin-slider.js?v=sage8"></script>
    <script src="app.js?v=sage8"></script>
  </body>
</html>
"""
