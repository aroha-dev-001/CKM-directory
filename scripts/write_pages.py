...
<html lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="style.css?v=sage4" />
    <link rel="stylesheet" href="carousel.css?v=sage4" />
  </head>
  <body data-page="{page}">
    ...
    <script src="data.js?v=sage4"></script>
    <script src="sections.js?v=sage4"></script>
    <script src="map.js?v=sage4"></script>
    <script src="carousel.js?v=sage4"></script>
    <script src="app.js?v=sage4"></script>
  </body>
</html>
"""
